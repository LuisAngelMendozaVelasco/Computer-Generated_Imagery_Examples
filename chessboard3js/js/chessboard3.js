            ...
            */
            ...
            function mouseMove(e, useTouchObject) {
                ...
                if (DRAG_INFO) {
                    ...
                    if (callOut || callOver) {
                        // var rc = raycast(coords.x, coords.y).source; // Original code
                        var rc = raycast(coords.x, coords.y); // Modified by Luis Mendoza
                        var currentPosition = deepCopy(CURRENT_POSITION);
                        // if (rc && rc.source && rc.source !== MOUSEOVER_SQUARE) { Original code
                        if (rc && rc.source !== MOUSEOVER_SQUARE) { // Modified by Luis Mendoza
